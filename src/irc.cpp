...
// Copyright (c) 2011-2012 universalbookingcoin Developers
...
void ThreadIRCSeed()
{
    ...
    RenameThread("universalbookingcoin-ircseed");
...
void ThreadIRCSeed2()
{
    ...
    while (true)
    {
        ...
        if (fTestNet) {
            Send(hSocket, "JOIN #universalbookingcoinTEST0\r");
            Send(hSocket, "WHO #universalbookingcoinTEST0\r");
        } else {
            // randomly join #universalbookingcoin00-#universalbookingcoin99
            // network is now over 3k peers , get them to join 50 random channels!
            //            channel_number = 0; 
            int channel_number = 0; //GetRandInt(50);

            Send(hSocket, strprintf("JOIN #universalbookingcoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #universalbookingcoin%02d\r", channel_number).c_str());
        }

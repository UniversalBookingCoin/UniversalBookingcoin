...
static const int64 MAX_MONEY = 2100000000 * COIN; // universalbookingcoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 1.5) / 250; // universalbookingcoin: Priority cutoff is 2 universalbookingcoin day / 250 bytes.
    }
